...
-- Started on 2025-10-03 17:53:26
...
--
-- TOC entry 254 (class 1259 OID 164074)
-- Name: exercises_leaderboard_ranked; Type: MATERIALIZED VIEW; Schema: public; Owner: postgres
--

CREATE MATERIALIZED VIEW public.exercises_leaderboard_ranked AS
 SELECT user_id,
    num_exercises,
    last_updated,
    rank() OVER (ORDER BY num_exercises DESC) AS "position"
   FROM public.exercises_leaderboard
  WITH NO DATA;


ALTER MATERIALIZED VIEW public.exercises_leaderboard_ranked OWNER TO postgres;
...
--
-- TOC entry 250 (class 1259 OID 164043)
-- Name: reps_leaderboard_ranked; Type: MATERIALIZED VIEW; Schema: public; Owner: postgres
--

CREATE MATERIALIZED VIEW public.reps_leaderboard_ranked AS
 SELECT user_id,
    reps,
    last_updated,
    rank() OVER (ORDER BY reps DESC) AS "position"
   FROM public.reps_leaderboard
  WITH NO DATA;


ALTER MATERIALIZED VIEW public.reps_leaderboard_ranked OWNER TO postgres;
...
--
-- TOC entry 248 (class 1259 OID 164027)
-- Name: sets_leaderboard_ranked; Type: MATERIALIZED VIEW; Schema: public; Owner: postgres
--

CREATE MATERIALIZED VIEW public.sets_leaderboard_ranked AS
 SELECT user_id,
    num_sets,
    last_updated,
    rank() OVER (ORDER BY num_sets DESC) AS "position"
   FROM public.sets_leaderboard
  WITH NO DATA;


ALTER MATERIALIZED VIEW public.sets_leaderboard_ranked OWNER TO postgres;
...
--
-- TOC entry 246 (class 1259 OID 164008)
-- Name: volume_leaderboard_ranked; Type: MATERIALIZED VIEW; Schema: public; Owner: postgres
--

CREATE MATERIALIZED VIEW public.volume_leaderboard_ranked AS
 SELECT user_id,
    volume,
    last_updated,
    rank() OVER (ORDER BY volume DESC) AS "position"
   FROM public.volume_leaderboard
  WITH NO DATA;


ALTER MATERIALIZED VIEW public.volume_leaderboard_ranked OWNER TO postgres;
...
--
-- TOC entry 252 (class 1259 OID 164058)
-- Name: workouts_leaderboard_ranked; Type: MATERIALIZED VIEW; Schema: public; Owner: postgres
--

CREATE MATERIALIZED VIEW public.workouts_leaderboard_ranked AS
 SELECT user_id,
    num_workouts,
    last_updated,
    rank() OVER (ORDER BY num_workouts DESC) AS "position"
   FROM public.workouts_leaderboard
  WITH NO DATA;


ALTER MATERIALIZED VIEW public.workouts_leaderboard_ranked OWNER TO postgres;
...
--
-- TOC entry 4942 (class 1259 OID 164073)
...
--
-- TOC entry 4941 (class 1259 OID 164042)
...
--
-- TOC entry 4940 (class 1259 OID 164026)
...
--
-- TOC entry 4966 (class 2606 OID 163902)
...
--
-- TOC entry 4950 (class 2606 OID 49360)
...
--
-- TOC entry 4951 (class 2606 OID 49355)
...
--
-- TOC entry 4967 (class 2606 OID 163943)
...
--
-- TOC entry 4968 (class 2606 OID 163938)
...
--
-- TOC entry 4975 (class 2606 OID 164068)
...
--
-- TOC entry 4943 (class 2606 OID 114720)
...
--
-- TOC entry 4944 (class 2606 OID 41084)
...
--
-- TOC entry 4969 (class 2606 OID 163980)
...
--
-- TOC entry 4970 (class 2606 OID 163985)
...
--
-- TOC entry 4949 (class 2606 OID 49342)
...
--
-- TOC entry 4964 (class 2606 OID 155696)
...
--
-- TOC entry 4965 (class 2606 OID 155691)
...
--
-- TOC entry 4962 (class 2606 OID 147509)
...
--
-- TOC entry 4963 (class 2606 OID 147504)
...
--
-- TOC entry 4961 (class 2606 OID 147496)
...
--
-- TOC entry 4973 (class 2606 OID 164037)
...
--
-- TOC entry 4972 (class 2606 OID 164021)
...
--
-- TOC entry 4954 (class 2606 OID 98367)
...
--
-- TOC entry 4955 (class 2606 OID 98379)
...
--
-- TOC entry 4953 (class 2606 OID 98355)
...
--
-- TOC entry 4952 (class 2606 OID 98343)
...
--
-- TOC entry 4971 (class 2606 OID 164002)
...
--
-- TOC entry 4946 (class 2606 OID 49208)
...
--
-- TOC entry 4947 (class 2606 OID 49203)
...
--
-- TOC entry 4956 (class 2606 OID 139321)
...
--
-- TOC entry 4957 (class 2606 OID 139316)
...
--
-- TOC entry 4958 (class 2606 OID 139336)
...
--
-- TOC entry 4959 (class 2606 OID 139331)
...
--
-- TOC entry 4948 (class 2606 OID 49221)
...
--
-- TOC entry 4960 (class 2606 OID 139346)
...
--
-- TOC entry 4974 (class 2606 OID 164053)
...
--
-- TOC entry 4945 (class 2606 OID 49191)
...
-- Dependencies: 254
-- Name: TABLE exercises_leaderboard_ranked; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.exercises_leaderboard_ranked TO localuser;
...
-- Dependencies: 250
-- Name: TABLE reps_leaderboard_ranked; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.reps_leaderboard_ranked TO localuser;
...
-- Dependencies: 248
-- Name: TABLE sets_leaderboard_ranked; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.sets_leaderboard_ranked TO localuser;
...
-- Dependencies: 246
-- Name: TABLE volume_leaderboard_ranked; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.volume_leaderboard_ranked TO localuser;
...
-- Dependencies: 252
-- Name: TABLE workouts_leaderboard_ranked; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.workouts_leaderboard_ranked TO localuser;


-- Completed on 2025-10-03 17:53:26
